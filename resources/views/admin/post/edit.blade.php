                           ...
                           <div class="x_content">
                              ...
                              <form class="form-horizontal form-label-left" method="post" action="{{url('/admin/post/update/'.$result['0']->id)}}" enctype="multipart/form-data">
								 ...
								 <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                       <textarea class="form-control"  name="short_desc" placeholder="Short Description">{{$result['0']->short_desc}}</textarea>
                                       @error('short_desc')
                                       <span class="field_error">{{$message}}</span>
                                       @enderror                                       
                                    </div>
								 ...
								 <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                       <textarea class="form-control"  name="long_desc" placeholder="Full Description">{{$result['0']->long_desc}}</textarea>
                                       @error('long_desc')
                                       <span class="field_error">{{$message}}</span>
                                       @enderror                                       
                                    </div>
