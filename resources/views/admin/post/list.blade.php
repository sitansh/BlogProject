						   ...
						   <table id="datatable" class="table table-striped table-bordered" style="width:100%">
							  ...
							  <tbody>
								 ...
								 <tr>
									...
									<td><a class="btn btn-info color_white" href="{{url('admin/post/edit/'.$list->id)}}">Edit</a>
									<a class="btn btn-danger color_white" href="{{url('admin/post/delete/'.$list->id)}}">Delete</a></td>
									</td>
								 </tr>
								 @endforeach
							  </tbody>
